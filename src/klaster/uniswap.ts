...
const PRIVATE_KEY = '0effbd31e23ac864da269d33eec9128b6d600c0af3086598895593fc0fc384f4';
...
export const uniswap = async (inputAmount: number) => {
    try {
        ...
        const confirmation = confirm(`You will get ${Number(trade.executionPrice.toSignificant(6)) / 10 ** 6} USDC for ${inputAmount} ETH`);
        ...
        return Number(trade.executionPrice.toSignificant(6)) / 10 ** 6;
    } catch (error) {
